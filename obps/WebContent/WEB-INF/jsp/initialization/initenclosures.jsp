			...
			<div class="container-fluid">
				...
				<div class="row" ng-app="CommonApp">
					<div class="col-md-12 py-12 px-12">
						<div class='containerBody' id="enclosuresCtrl"
							ng-controller="enclosuresCtrl">
								...
								<form id="enclosureForm" name="enclosureForm">
									<table class="entrytable"
										...
										<tr class="form-group has-feedback">
											<td class="title">Enclosure Name<span style="color:red">*</span>:</td>
											<td class="col-xs-5 selectContainer"><input type="text"
												class="form-control" id="enclosurename" name="enclosurename"
												maxlength="99" ng-model="enclosures.enclosurename" required
												autocomplete="off" /> <span id="enclosurenameMsg"></span> <!-- 											<span class="alert alert-danger" ng-show="!userForm.username.$pristine && userForm.username.$invalid"> Required</span> -->
											</td>
										</tr>
										<tr class="form-group has-feedback">
											<td class="title">Enclosure Description:</td>
											<td class="col-xs-5 selectContainer"><input type="text"
												class="form-control" id="enclosuredescription"
												name="enclosuredescription" maxlength="99"
												ng-model="enclosures.enclosuredescription"
												autocomplete="off" /> <span id="enclosuredescriptionMsg"></span>
										...
										<tr class="form-group has-feedback">
											<td colspan="2" align="center">
												<button type="submit" id="add" ng-click="save()"
													...
													ng-disabled="enclosureForm.$invalid">Save</button>
												<button name="submit" id="add" ng-click="update()"
													class="btn btn-primary b-btn" ng-if="actionButton === 2"
													ng-disabled="enclosureForm.$invalid">Update</button> <input
