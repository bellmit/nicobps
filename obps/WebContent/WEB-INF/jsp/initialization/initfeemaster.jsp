<html>
<head>
<title>OBPS | Create Fee Master</title>
								...
								<form id="feemasterForm" name="feemasterForm">
									...
									<table class="entrytable"
										...
										<tr class="form-group has-feedback">
											...
											<td class="col-xs-3"><select class="form-control" id='officecode'
										...
										<tr class="form-group has-feedback">
											...
											<td  class="col-xs-3"><select class="form-control" id='licenseetypecode'
										...
										<tr class="form-group has-feedback">
											...
											<td  class="col-xs-3"><select id='feetypecode' class="form-control" ng-model='feemaster.feetypes.feetypecode'
												style="min-width: 350px;">
