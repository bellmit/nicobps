<html>
	<head>
		<title>OBPS | Create Licensees Registration</title>
	...
	<div class="d-flex" id="wrapper">
	    ...
	    <div id="page-content-wrapper">	
	      ...
	      <div class="container-fluid">
	        <h3 class="mt-4" style="font-size:32px;">Create Licensees Registration</h3>
	        
	        <div class="row" ng-app="CommonApp">	         	
	        	<div class="col-md-12 py-12 px-12">
	        		<div class='containerBody' id="createlicenseesregCtrl" ng-controller="createlicenseesregCtrl">            
			            <div  style='width:100%;margin: 15px auto 0'>
			                <form id="licenseeForm" name="licenseeForm">
			                    <table class="entrytable" style="width:70%;margin: 0px auto; border-spacing: 10px"> 
			                        
			                        <tr class="form-group has-feedback">
			                            <td class="title">Licensee Description:*</td>
			                            <td class="col-xs-5 selectContainer">
											<input type="text" class="form-control" id="licenseedescription" name="licenseedescription" maxlength="99"
												ng-model="licensees.licenseedescription" required autocomplete="off"/>        
											<span id="licenseedescriptionMsg"></span>
<!-- 											<span class="alert alert-danger" ng-show="!userForm.username.$pristine && userForm.username.$invalid"> Required</span> -->
  ...
  <script src="resources/js/application/initialization/initlicenseesregistrationsm.js"></script>
</html>