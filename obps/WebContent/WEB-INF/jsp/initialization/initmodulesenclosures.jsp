			...
			<div class="container-fluid">
				...
				<div class="row" ng-app="CommonApp">
					<div class="col-md-12 py-12 px-12">
						<div class="containerBody" id="initmodulesenclosuresCtrl"
							...
							<form>
								<table class="" style="width: 100%; margin: 0px auto">
									...
									<tr>
										<td class="title" style="width: 15%"><b>Module Name :</b></br></br>{{module.modulename}}</br></br></td>
<!-- 										<td><span>{{module.modulename}}</span></br></br></br></br></td> -->
									</tr><tr>
										<td><b> Process* :</b><select id='processcode' ng-options="T.key as T.value for T in processesList"
											style='width: 300px' class="form-control"
