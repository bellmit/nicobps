	...
	<div class="d-flex" id="wrapper">
	    ...
	    <div id="page-content-wrapper">	
	      ...
	      <div class="container-fluid">
	        <h3 class="mt-4" style="font-size:32px;">Initialize File Types</h3>
	        
	        <div class="row" ng-app="CommonApp">	         	
	        	<div class="col-md-12 py-12 px-12">
	        		<div class='containerBody' id="createfiletypeCtrl" ng-controller="createfiletypeCtrl">            
			            <div  style='width:100%;margin: 15px auto 0'>
			                <form id="filetypeForm" name="filetypeForm">
			                    <table class="entrytable" style="width:70%;margin: 0px auto; border-spacing: 10px"> 
			                        
			                        <tr class="form-group has-feedback">
			                            <td class="title">File Type Description:*</td>
			                            <td class="col-xs-5 selectContainer">
											<input type="text" class="form-control" id="filetypedescription" name="filetypedescription" maxlength="99"
												ng-model="filetype.filetypedescription" required autocomplete="off"/>        
											<span id="filetypedescriptionMsg"></span>
<!-- 											<span class="alert alert-danger" ng-show="!userForm.username.$pristine && userForm.username.$invalid"> Required</span> -->
  ...
  <script src="resources/js/application/initialization/initfiletypes.js"></script>
</html>