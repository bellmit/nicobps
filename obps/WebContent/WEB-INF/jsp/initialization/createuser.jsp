			                        ...
			                        <tr class="form-group has-feedback">
			                            ...
			                            <td class="col-xs-5 selectContainer">
											<input type="text" class="form-control" id="fullname" name="fullname" maxlength="99"
												ng-model="user.fullname" required autocomplete="off"/>        
...
<!-- 											<span class="alert alert-danger" ng-show="!userForm.username.$pristine && userForm.username.$invalid"> Required</span> -->
			                        ...
			                        <tr class="form-group has-feedback">
			                            ...
			                            <td class="col-xs-5 selectContainer">
											<input type="text" class="form-control" id="username" name="username" maxlength="99"
												ng-model="user.username" required autocomplete="off"/>        
...
<!-- 											<span class="alert alert-danger" ng-show="!userForm.username.$pristine && userForm.username.$invalid"> Required</span> -->
			                        ...
			                        <tr class="form-group has-feedback">
			                            ...
			                            <td class="col-xs-5 selectContainer">
			                                <input class="form-control" type="password" name="passwords" id="passwords" ng-model="user.userpassword" maxlength="512" autocomplete="new-password" required/>
...
<!-- 			                                <span class="alert alert-danger" ng-show="!userForm.passwords.$pristine && userForm.passwords.$invalid"> Required</span> -->
			                        ...
			                        <tr class="form-group has-feedback">
			                            ...
			                            <td class="col-xs-5 selectContainer">
			                                <input class="form-control" type="password"  id="repassword" name="repassword" ng-model="user.repassword" maxlength="512" autocomplete="new-password" required/>
			<!--                                 <label ng-if="user.usercode > 0" style="color:blue"> *Keep BLANK incase password is unchanged</label> -->
			                                <label ng-if="user.repassword != user.userpassword && userForm.repassword.$dirty" style="color:red">*password is not matching</label>
...
<!-- 			                                <span class="alert alert-danger" ng-show="!userForm.repassword.$pristine && userForm.repassword.$invalid"> Required</span> -->
			                        ...
			                        <tr class="form-group has-feedback">
			                            ...
			                            <td class="col-xs-5 selectContainer">
			                                <input class="form-control" type="text"  id="designation" name="designation" ng-model="user.designation" maxlength="99" autocomplete="off" required/>
			<!--                                 <label ng-if="user.usercode > 0" style="color:blue"> *Keep BLANK incase password is unchanged</label> -->
...
<!-- 			                                <span class="alert alert-danger" ng-show="!userForm.repassword.$pristine && userForm.repassword.$invalid"> Required</span> -->
			                        ...
			                        <tr class="form-group has-feedback">
			                            ...
			                            <td class="col-xs-5 selectContainer">
											<input type="number" class="form-control" id="mobileno" name="mobileno" maxlength="10" pattern="^([1-9]){1}([0-9]){9}$" 
												ng-model="user.mobileno" required  autocomplete="off"/>        
