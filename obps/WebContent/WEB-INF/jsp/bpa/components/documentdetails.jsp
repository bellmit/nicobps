...
<div class="card mb-4">
	<div class="card-body">
		...
		<div class="form-group" ng-repeat="D in DocumentDetails | orderBy: processcode">
			<div class="card bg-light text-dark">
		   		<div class="card-body">
		   			<div class="row">
		   				<label class="col-sm-6"><small>File</small></label>
		   				<label class="col"><small>Uploaded during process</small></label>
		   				<label class="col"><small>Uploaded Date</small></label>
		   				<label class="col"><small></small></label>
		   			</div>
		   			<div class="row">
		   				<label class="col-sm-6">{{D.enclosurename}}</label>
		   				<label class="col">{{D.processname}}</label>
