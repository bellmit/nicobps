...
<div class="card mb-4">
	<div class="card-body">
		...
		<div class="form-group">
			<div class="row">
				<div class="col">
					<label class="col-sm-12"><small>Ownership type</small></label> 
					<label class="col-sm-12">{{basicDetail.ownershiptypename}}</label>
				</div>
				<div class="col">
					<label class="col-sm-12"><small>Ownership Subtype</small></label> 
					<label class="col-sm-12">{{basicDetail.ownershipsubtype}}</label>
				</div>
			</div>
		</div>
		<div class="card pt-2" ng-repeat="O in OwnerDetails">
			...
			<div class="row">
				<div class="col-sm-3">
					<label class="col-sm-12"><small>Owner Name</small></label> 
					<label class="col-sm-12">{{O.ownername}}</label>
				</div>
				<div class="col-sm-3">
					<label class="col-sm-12"><small>Mobile No.</small></label> 
					<label class="col-sm-12">{{O.mobileno}}</label>
				</div>
				<div class="col-sm-3">
