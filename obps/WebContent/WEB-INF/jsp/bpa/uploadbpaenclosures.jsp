...
<form:form  method="POST" action="submitbpaenclosures.htm?${_csrf.parameterName}=${_csrf.token}" modelAttribute="BpaEnclosures" name="BpaEnclosures" id="BpaEnclosures" enctype="multipart/form-data" onsubmit="javascript:return onbeforeSubmit()">
			...
			<table id="entrytable">						  										
                 ...
                 <tr>                       
                     ...
                     <td>
                       ...
                       <td>					   
						<core:if  test="${not empty enclosur.value2}">						
							<a  href="outputbpa.htm?applicationcode=${enclosur.value2}&enclosurecode=${enclosur.key}" target="_blank">View Enclosures</a>
						</core:if>      										
				     </td> 
